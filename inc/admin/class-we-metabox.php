...
if ( ! class_exists( 'WE_Admin_Metabox' ) ) {
	/**
	 * Metabox class
	 *
	...
	class WE_Admin_Metabox {
		...
		public function admin_scripts() {
			...
			/* Datepicker CSS */
			wp_enqueue_style( 'jquery-ui-custom', WE_CSS . '/admin/jquery-ui-custom.min.css', array(), WE_VERSION, 'all' );

			/* Datepicker JS */
			wp_enqueue_script( 'wolf-events-datepicker', WE_JS . '/admin/datepicker.min.js', array( 'jquery-ui-datepicker' ), false, true );
		}
			...
			foreach ( $meta_fields as $field ) {
				...
				<td>";
					...
					// datepicker
						...
						echo '<input type="text" class="wolf-event-metabox-datepicker" name="' . $field['id'] . '" id="' . $field['id'] . '" value="' . $meta . '" size="30">
						<br><span class="description">' . $desc . '</span>';
					...
					<div>
						...
						<br><a href="#" class="button wolf-options-reset-file"><?php esc_html_e( 'Clear', 'wolf-events' ); ?></a>
						<a href="#" class="button wolf-options-set-file"><?php esc_html_e( 'Choose a file', 'wolf-events' ); ?></a>
					</div>
					...
					<div>
						...
						<br><a href="#" class="button wolf-options-reset-img"><?php esc_html_e( 'Clear', 'wolf-events' ); ?></a>
						<a href="#" class="button wolf-options-set-img"><?php esc_html_e( 'Choose an image', 'wolf-events' ); ?></a>
					</div>
					...
					-------------------------------------------*/
						...
						?>
						<p><?php esc_html_e( 'Background color', 'wolf-events' ); ?></p>
						...
						?>
						<p><?php esc_html_e( 'Background image', 'wolf-events' ); ?></p>
						<div>
							...
							<br><a href="#" class="button wolf-options-reset-bg"><?php esc_html_e( 'Clear', 'wolf-events' ); ?></a>
							<a href="#" class="button wolf-options-set-bg"><?php esc_html_e( 'Choose an image', 'wolf-events' ); ?></a>
						</div>
						<br><br>
						<?php
						}
						...
						?>
						<br>
						<p><?php esc_html_e( 'Background repeat', 'wolf-events' ); ?></p>
						...
						?>
						<br><br>
						<p><?php esc_html_e( 'Background position', 'wolf-events' ); ?></p>
						...
						--------------------*/
						$options = array(
							'cover' => esc_html__( 'cover (resize)', 'wolf-events' ),
							'normal' => esc_html__( 'normal', 'wolf-events' ),
							'resize' => esc_html__( 'responsive (hard resize)', 'wolf-events' ),
						);

						?>
						<br><br>
						<p><?php esc_html_e( 'Background size', 'wolf-events' ); ?></p>
						...
						if ( $parallax ) {
							?>
							<br><br>
							<p><strong><?php esc_html_e( 'Parallax', 'wolf-events' ); ?></strong></p>
					...
					-------------------------------------------*/
						...
						if ( ! in_array( 'color', $exclude_params ) ) {
						?>
						<p><?php esc_html_e( 'Font color', 'wolf-events' ); ?></p>
						...
						?>
							<p><?php esc_html_e( 'Font Family', 'wolf-events' ); ?></p>
							<select name="<?php echo esc_attr( $field_id ) . '_font_name'; ?>" id="<?php echo esc_attr( $field_id ) . '_font_name'; ?>">
								<option value=''><?php esc_html_e( 'default', 'wolf-events' ); ?></option>
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font weight', 'wolf-events' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'For example: 400 is normal, 700 is bold.The available font weights depend on the font.<br>Leave empty to use the theme default style', 'wolf-events' ); ?></span>
						<?php
						}

						if ( ! in_array( 'transform', $exclude_params ) ) {
							$options = array(
								'' => esc_html__( 'auto', 'wolf-events' ),
								'none' => esc_html__( 'none', 'wolf-events' ),
								'uppercase' => esc_html__( 'uppercase', 'wolf-events' ),
							);
						?>
							<br><br>
							<p><?php esc_html_e( 'Font transform', 'wolf-events' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style in the theme options', 'wolf-events' ); ?></span>
						<?php
						}
						...
						if ( ! in_array( 'style', $exclude_params ) ) {
							$options = array(
								'' => esc_html__( 'auto', 'wolf-events' ),
								'normal' => esc_html__( 'normal', 'wolf-events' ),
								'italic' => esc_html__( 'italic', 'wolf-events' ),
							);
						?>
							<br><br>
							<p><?php esc_html_e( 'Font style', 'wolf-events' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( '"auto" is the default style defined in the theme options', 'wolf-events' ); ?></span>
						<?php
						}
						...
						?>
							<br><br>
							<p><?php esc_html_e( 'Font letter spacing (omit px)', 'wolf-events' ); ?></p>
							...
							<br><span class="description"><?php esc_html_e( 'Leave empty to use the style defined in the theme options', 'wolf-events' ); ?></span>
						<?php
						}
					...
					-------------------------------------------*/
						...
						?>
						<div>
							<p><strong><?php esc_html_e( 'mp4 URL', 'wolf-events' ); ?></strong></p>
						...
						<div>
							<p><strong><?php esc_html_e( 'webm URL', 'wolf-events' ); ?></strong></p>
						...
						<div>
							<p><strong><?php esc_html_e( 'ogv URL', 'wolf-events' ); ?></strong></p>
						...
						<div>
						<p><strong><?php esc_html_e( 'Video Image Fallback', 'wolf-events' ); ?></strong></p>
						<input type="hidden"  name="<?php echo esc_attr( $field_id ); ?>_img" id="<?php echo esc_attr( $field_id ); ?>_img" value="<?php echo esc_attr( $img ); ?>">
